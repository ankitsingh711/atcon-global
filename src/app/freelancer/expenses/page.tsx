...
const expenses = [
    { description: 'Software License - VS Code Extensions', category: 'Software', amount: '$45.00', date: 'Mar 3, 2026', status: 'Pending' },
    { description: 'Co-working space rental', category: 'Office', amount: '$200.00', date: 'Mar 1, 2026', status: 'Approved' },
    { description: 'Cloud hosting - AWS', category: 'Infrastructure', amount: '$89.00', date: 'Feb 28, 2026', status: 'Approved' },
];
const st: Record<string, { bg: string; text: string }> = { Pending: { bg: '#FEF3C7', text: '#D97706' }, Approved: { bg: '#DCFCE7', text: '#16A34A' } };
...
export default function FreelancerExpensesPage() {
    return (
        <Box>
            ...
            <Typography variant="body2" sx={{ color: '#64748B', mb: 3 }}>Expense claims</Typography>
