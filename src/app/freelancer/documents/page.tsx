...
const documents = [
    { name: 'Freelancer Agreement', type: 'PDF', size: '1.8 MB', date: 'Mar 2024', category: 'Contract' },
    { name: 'NDA - Acme Corp', type: 'PDF', size: '520 KB', date: 'Mar 2024', category: 'Legal' },
    { name: 'Invoice Template', type: 'DOC', size: '120 KB', date: 'Jan 2026', category: 'Finance' },
    { name: 'Tax Form W-9', type: 'PDF', size: '340 KB', date: 'Jan 2026', category: 'Tax' },
];
